class APIData {
  ...
  static const String domainLink = "https://dooo.bin-bash.ir/public/";
  ...
  static const String userProfileApi = domainApiLink + "userProfile?secret=" + secretKey;
  static const String freeSubscription = domainApiLink + "free/subscription?secret=" + secretKey;
  ...
  static const String movieTvApi = domainApiLink + "movietv?secret=" + secretKey;
  ...
  static const String watchListApi = domainApiLink + "showwishlist?secret=" + secretKey;
  static const String watchHistory = domainApiLink + "watchhistory?secret=" + secretKey;
  static const String addWatchHistory = domainApiLink + "addwatchhistory";
  static const String deleteAllWatchHistory = domainApiLink + "delete_watchhistory?secret=" + secretKey;
  ...
  static const String addWatchlist = domainApiLink + "addwishlist?secret=" + secretKey;
  ...
  static const String userProfileUpdate = domainApiLink + "profileupdate?secret=" + secretKey;
  static const String stripeProfileApi = domainApiLink + "stripeprofile?secret=" + secretKey;
  static const String stripeDetailApi = domainApiLink + "stripedetail?secret=" + secretKey;
  static const String clientNonceApi = domainApiLink + "bttoken?secret=" + secretKey;
  static const String sendPaymentNonceApi = domainApiLink + "btpayment?secret=" + secretKey;
  ...
  static const String sendPaystackDetails = domainApiLink + "paystack?secret=" + secretKey;
  static const String applyCouponApi = domainApiLink + "applycoupon";
  static const String showScreensApi = domainApiLink + "showscreens?secret=" + secretKey;
  static const String screensProfilesApi = domainApiLink + "screenprofile?secret=" + secretKey;
  static const String updateScreensApi = domainApiLink + "updatescreen?secret=" + secretKey;
  static const String screenLogOutApi = domainApiLink + "logout";
  static const String couponPaymentApi = domainApiLink + "couponpayment";
  static const String notificationsApi = domainApiLink + "notifications?secret=" + secretKey;
  static const String sendRazorDetails = domainApiLink + "paystore?secret=" + secretKey;
  static const String postVideosRating = domainApiLink + "rating?secret=" + secretKey;
  static const String checkVideosRating = domainApiLink + "checkrating";
  static const String downloadCounter = domainApiLink + "downloadcounter?secret=" + secretKey;
  static const String postBlogComment = domainApiLink + "addcomment?secret=" + secretKey;
  static const String actorMovies = domainApiLink + "detail/";
  static const String applyGeneralCoupon = domainApiLink + "verifycoupon?secret=" + secretKey;
  ...
  static const String manualPayments = domainApiLink + "manualPayment?secret=" + secretKey;
  static const String storeManualPayments = domainApiLink + "store/manualPayment?secret=" + secretKey;
  static const String language = domainApiLink + "alllanguage?secret=" + secretKey;
  static const String appUiShorting = domainApiLink + "appUiShorting?secret=" + secretKey;
  static const String allUsers = domainApiLink + "allusers?secret=" + secretKey;
  static const String postSubComment = domainApiLink + "addreply?secret=" + secretKey;
  static const String audios = domainApiLink + "audio?secret=" + secretKey;
  static const String liveEvents = domainApiLink + "liveEvent?secret=" + secretKey;
  static const String countViews = domainApiLink + "countView?secret=" + secretKey;
  ...
  static const String recommendedData = domainApiLink + "recomended?secret=" + secretKey;
  ...
  static const String episodeThumbnail = domainLink + "images/tvseries/episodes/";

  // Replace with your app name
  static const String appName = 'InoStream';

  // Replace with your app secret key
  static const String secretKey = "bed46963-2968-4459-ba0a-cd1d0f78766e";
  ...
  static const String googleDriveApi = "AIzaSyCeUQwc7V8k4Gk1zRblVNoA82k8SH89US8";
  ...
  static const String liveEventThumbnail = domainLink + 'images/events/thumbnails/';
...
// Firbase keys for ANDROID
  ...
  static const String appIdAndroid = '1:140456718264:android:ca76662ed677e207b5294d';
  ...
  static const String projectIdIos = 'inostream-f7e37';
  static const String storageBucketIos = 'inostream-f7e37.appspot.com';
  static const String iosBundleId = 'com.mediacity.inostream';
